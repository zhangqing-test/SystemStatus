...
// LoggerFactory.getLogger(AutoUpdateBatch.class);
//
...
//
// try {
// String cmd = "cmd /c \"cd " + PROJECT_PATH + "&&" + "call mvn tomcat:redeploy
// -Dmaven.test.skip=true -Dip=" + ip + "\"";
// System.err.println(cmd);
// LOG.info("Start>>>>>>>>>>>>>>>>>>>>>>>>>>>");
// Process ps = Runtime.getRuntime().exec(cmd);
// BufferedReader br = new BufferedReader(new
// InputStreamReader(ps.getInputStream(), "UTF-8"));// 注意中文编码问题
// String line;
...
// HttpPost httpPost2 = new HttpPost("http://" + ip +
// ":9090/SystemControl/services/SystemService?wsdl");
// String wsdlData2 = "<soapenv:Envelope
// xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\"
// xmlns:ser=\"http://webService.system.com\"
// xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\"
// xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\">" + "<soapenv:Body>
...
// StringEntity myEntity2 = new StringEntity(wsdlData2,
// ContentType.create("text/xml", "UTF-8"));
