...
<!-- 			</div> -->
		...
		<table class="table table-responsive input-sm">
			...
			<thead>
				<tr>
					<th class="col-xs-5 col-sm-5 col-lg-5" style="width:100px;">创建时间</th>				
					<th class="col-xs-5 col-sm-5 col-lg-5" style="width:100px;">IP</th>
					<th class="col-xs-5 col-sm-5 col-lg-5" style="width:100px;">名称</th>
			...
			<tbody>
				<c:forEach var="data" items="${list }">
					<tr>
						<td class="col-xs-5 col-sm-5 col-lg-5" style="width:100px;"><fmt:formatDate type="both" value="${data.datetime }" /></td>
						<td class="col-xs-5 col-sm-5 col-lg-5" style="width:100px;">${data.ip}</td>
						<td class="col-xs-5 col-sm-5 col-lg-5" style="width:100px;">${data.name }</td>
